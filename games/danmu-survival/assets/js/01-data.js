  ...
  D.phase2 = {
    ...
    systemPrompt(s) {
      ...
      return [
        ...
        `世界规则：旧时代的纸币已彻底作废，末日里没人收钱，绝不存在"用钱买/付钱"的选项或情节。唯一硬通货是"晶核"，且晶核【只能】通过击杀丧尸/变异体获得（战斗结算时由系统发放），交易一律以物易物或用晶核。晶核可升级异能。战斗用跑团骰：战力=异能等级×10+d20，等级差≥2必胜。【严禁】在非战斗剧情里凭空发放晶核——主角想要晶核，就必须去打丧尸。`,
        ...
        'hp 平时填 0，只有主角确实受伤/恢复时才填非0。crystals 字段：正数无效（晶核只能由战斗结算发放，系统会处理），平时一律填 0；仅当主角主动用晶核交易/以物易物/交保护费时才填负数表示消耗。严禁凭空奖励，开场不要给晶核或回血。',
