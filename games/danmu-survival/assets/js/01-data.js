...
(function () {
  ...
  D.phase2 = {
    ...
    directorNote(day, s) {
      ...
      const radio = s && s.hasRadio ? '收音机线已开启：可用断续广播投放基地、尸潮和141线索。' : '收音机线未开启：适合在搜刮、便利店、保安室或废车里安排一次获得机会。';
  ...
  D.radioByDay = function (n) {
    const U = DS.util;
    return [
      { tag: '电波', h: 'Z频道·幸存者广播', b: U.pick([
        '……西郊基地仍在接收幸存者，认准骷髅旗，重复，认准骷髅旗……',
        '……今日感染体活动频繁，夜间切勿点灯，切勿外出……',
        '……据报，城东超市仍有未被清空的物资，风险自负……',
        '……一支自称141的小队在城区活动，遇到他们……是你的运气……',
      ]) },
    ];
  };
