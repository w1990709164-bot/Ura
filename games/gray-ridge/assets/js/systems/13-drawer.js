...
function initDrawer() {
  ...
  const onMove = e => {
    ...
    if (dy > 30) collapseDrawer();
    else if (dy < -30) expandDrawer();
  };
...
function collapseDrawer() {
  ...
  document.getElementById('bottom-drawer').classList.add('collapsed');
}
